            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="blog-post">
                        ...
                        <div class="down-content">
                            <span>Lifestyle</span>
                            <a href="/detail"><h4>Best Template Website for HTML CSS</h4></a>
                            <ul class="post-info">
                ...
                <div class="col-lg-12">
                    <div class="blog-post">
                        ...
                        <div class="down-content">
                            <span>Healthy</span>
                            <a href="/detail"><h4>Etiam id diam vitae lorem dictum</h4></a>
                            <ul class="post-info">
                                <li><a href="#">Admin</a></li>
                ...
                <div class="col-lg-12">
                    <div class="blog-post">
                        ...
                        <div class="down-content">
                            <span>Fashion</span>
                            <a href="/detail"><h4>Donec tincidunt leo nec magna</h4></a>
                            <ul class="post-info">
                                <li><a href="#">Admin</a></li>
